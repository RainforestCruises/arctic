...
<div class="itinerary-hero">
    ...
    <!-- Top Section -->
    <div class="itinerary-hero__top">
        <div class="itinerary-hero__top__bg" id="top">
        ...
        <!-- Title / Navigation -->
        <div class="itinerary-hero__top__content">

            <!-- Breadcrumb -->
            <ol class="itinerary-hero__top__content__breadcrumb">
                <li>
            ...
            <div>
                <!-- H1 Title / Subtitle -->
                <div class="itinerary-hero__top__content__title-group">
                    <?php if ($charter_view) : ?>
                        <div class="itinerary-hero__top__content__title-group__badge-area">
                            <span>
                                Private Charter
                            </span>
                        </div>
                    ...
                    <h1 class="itinerary-hero__top__content__title-group__title" id="template-nav-title">
                        <div>
                    ...
                    <div class="itinerary-hero__top__content__title-group__subtitle"><?php echo get_field('top_snippet') ?></div>
                </div>

                <!-- Navigation Wrapper -->
                <nav class="itinerary-hero__top__content__nav" id="template-nav">

                    <!-- nav list -->
                    <ul class="itinerary-hero__top__content__nav__list">

                        <li class="itinerary-hero__top__content__nav__list__item current">
                            <a href="#overview" class="itinerary-hero__top__content__nav__list__item__link page-nav-template">Overview</a>
                        </li>

                        <li class="itinerary-hero__top__content__nav__list__item">
                            <a href="#itineraries" class="itinerary-hero__top__content__nav__list__item__link page-nav-template">Itinerary</a>
                        </li>
                        <li class="itinerary-hero__top__content__nav__list__item ">
                ...
                <div class="itinerary-hero__top__content__cta">
            ...
            <div class="itinerary-hero__bottom__content__info-group">
                ...
                <div class="itinerary-hero__bottom__content__info-group__info" id="page-title">
                    ...
                    <div class="itinerary-hero__bottom__content__info-group__info__starting-price">
                        <div class="itinerary-hero__bottom__content__info-group__info__starting-price__title-area">
