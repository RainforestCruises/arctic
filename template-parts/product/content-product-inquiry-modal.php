                ...
                <div class="cabins-modal__content">
                    ...
                    <?php foreach ($departures  as $d) :
                        ...
                        <?php foreach ($cabins as $cabin) :
                            $cabinPost = $cabin['cabin']; //TODO just use cabin id
                            $cabinId = $cabinPost->ID;
                            $title =  get_field('display_name', $cabinId);
                            $dimensions =  get_field('dimensions', $cabinId);
                            $is_single =  get_field('is_single', $cabinId);
                            $is_sharable =  get_field('is_sharable', $cabinId);
                            $capacity =  get_field('capacity', $cabinId);
                            $quantity =  get_field('quantity', $cabinId);
                            $beds =  get_field('beds', $cabinId);
