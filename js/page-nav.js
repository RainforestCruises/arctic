jQuery(document).ready(function ($) {
    ...
    $('.product-hero-badge--deal, .product-hero-badge--special, .nav-secondary__content__title-area__link, .nav-secondary__mobile-menu__list__item__link, .nav-secondary__content__links__link, .product-hero__content__main__primary__nav__link, .landing-nav__content__links__link, #down-arrow-button').click(function (event) {
